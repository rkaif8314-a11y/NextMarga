...
export const sampleOpportunities: Opportunity[] = [
  {
    id: "math-olympiad-demo",
    title: "Mathematics Opportunity (Demo)",
    ...
    whyConsider: "This sample mathematics opportunity is a premier national-level competition designed to identify and nurture young mathematical talent. Participating in this Olympiad not only sharpens problem-solving skills but also provides a significant academic credential that is recognized by top educational institutions nationwide. It's an excellent stepping stone for students aiming for advanced STEM careers.",
  ...
  {
    id: "national-talent-exam-demo",
    title: "National Talent Search Example (Demo)",
    category: "exam",
    isVerified: true,
    isGovt: true,
    deadline: "2026-11-20",
...
export const sampleApplications: ApplicationItem[] = [
  ...
  {
    id: "app-4",
    opportunityId: "math-olympiad-demo",
    title: "Mathematics Opportunity (Demo)",
...
export const sampleInitialChatMessages: ChatMessage[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        id: "open-source-youth-demo",
        title: "Open-source youth program",
        eligibility: "Ages 13-17",
        scope: "Global",
        opportunityId: "open-source-youth-demo"
      }
    ]
  }
];
