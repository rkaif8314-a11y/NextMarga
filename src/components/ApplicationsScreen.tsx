      ...
      <div className="w-full max-w-3xl max-h-[92vh] overflow-y-auto rounded-2xl border border-slate-200 bg-white shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        {dossier && <>
          ...
          <div className="p-5 space-y-5">
            ...
            {dossier.officialUrl && <a href={dossier.officialUrl} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 py-3 rounded-xl bg-sky-700 text-slate-950 text-xs uppercase tracking-widest font-medium"><ExternalLink className="w-4 h-4" />Open official application portal</a>}
          </div>
        </>}
      </div>
    </div>}
